...
ActiveRecord::Schema.define(version: 20170215171803) do
  ...
  create_table "project_rms", force: :cascade do |t|
    ...
    t.integer  "rm_eosysprio",       default: 5
    t.integer  "rm_prio_low",        default: 1
    t.integer  "rm_prio_normal",     default: 2
    t.integer  "rm_prio_high",       default: 3
    t.integer  "rm_prio_urgent",     default: 4
    t.integer  "rm_prio_immediate",  default: 5
  end
