...
ActiveRecord::Schema.define(version: 20160829104332) do
  ...
  create_table "project_rms", force: :cascade do |t|
    ...
    t.integer  "rm_plm",             limit: 4,   default: 4
    ...
    t.string   "rm_tracker_manuf",   limit: 255, default: "Manufacture"
    t.string   "rm_tracker_delin",   limit: 255, default: "Delineate"
    t.string   "rm_tracker_meas",    limit: 255, default: "Measure"
    t.string   "rm_tracker_doc",     limit: 255, default: "Document"
    t.string   "rm_tracker_design",  limit: 255, default: "Design"
    t.string   "rm_tracker_valid",   limit: 255, default: "Validate"
    t.string   "rm_tracker_superv",  limit: 255, default: "Supervise"
    t.string   "rm_tracker_fab",     limit: 255, default: "Fabrication"
    t.string   "rm_tracker_com",     limit: 255, default: "Commercial"
    t.string   "rm_tracker_subc",    limit: 255, default: "Subcontract"
    t.string   "rm_tracker_integ",   limit: 255, default: "Integration"
    t.string   "rm_status_resolved", limit: 255, default: "Resolved"
    t.string   "rm_status_new",      limit: 255, default: "New"
    t.integer  "rm_eosysprio",       limit: 4,   default: 5
    t.integer  "rm_prio_low",        limit: 4,   default: 1
    t.integer  "rm_prio_normal",     limit: 4,   default: 2
    t.integer  "rm_prio_high",       limit: 4,   default: 3
    t.integer  "rm_prio_urgent",     limit: 4,   default: 4
    t.integer  "rm_prio_immediate",  limit: 4,   default: 5
  end
